    ...
    >
      ...
      >
        <div className="flex items-center justify-center gap-6 sm:gap-8">
          <Image 
            ...
            width={72} 
            height={72} 
            className="rounded-[1.5rem] shadow-xl shadow-white/5 w-16 h-16 sm:w-20 sm:h-20"
          />
          <h1 className="text-6xl sm:text-7xl lg:text-8xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-white to-white/50 leading-tight">
            Cumo
          </h1>
        </div>
      ...
      >
        ...
        >
          ...
          <span className="text-xs font-medium text-white/60 group-hover:text-white transition-colors tracking-wide">
            mqnch/Cumo
          </span>
        </motion.a>
        ...
        >
          ...
          <span className="text-[10px] sm:text-xs font-semibold tracking-[0.2em] uppercase text-white/60 mt-[1px]">
            Release Build Coming Soon
          </span>
        </div>

        <div className="relative w-full aspect-[16/10] sm:aspect-video rounded-2xl sm:rounded-[2rem] p-[1px] bg-gradient-to-b from-white/20 to-transparent overflow-hidden shadow-2xl shadow-white/[0.03]">
      ...
      >
        ...
        <div className="flex flex-col items-center text-center" style={{ gap: '1.25rem' }}>
          ...
          <div className="flex flex-col items-center" style={{ gap: '0.5rem' }}>
            <h3 className="text-xl font-bold tracking-tight text-white/90">Radically Minimal</h3>
            <p className="text-white/60 text-sm leading-relaxed max-w-[260px]">
